  ...
  return (
    <div className="col-span-12 p-4 rounded border border-stone-300">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button className="text-sm text-deepblue-500 hover:underline">
          See all
        </button>
      </div>
...
function TableRow({ cusId, sku, date, price, order }) {
  return (
    <tr className={order % 2 ? "bg-stone-100 text-sm" : "text-sm"}>
      <td className="p-1.5">
        <Link href="#" className="text-deepblue-500 underline flex items-center gap-1">
