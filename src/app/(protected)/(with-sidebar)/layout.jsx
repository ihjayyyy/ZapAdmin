...
import { OperatorFilterProvider } from "@/context/OperatorFilterContext";
...
const SidebarLayout = ({ children }) => {
  ...
  // OperatorFilterProvider wraps everything here so both TopBar (which renders the
  // operator dropdown) and any page content (which reads the selected operator) share it.
  // It relies on useAuth() internally, so this must sit inside AuthProvider - if AuthProvider
  // wraps SidebarLayout from a level above (e.g. root layout), this is all that's needed.
  return (
