      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        ...
        {displayError && (
          <div className="mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md flex items-center">
            <FiAlertCircle size={18} className="mr-2 flex-shrink-0" />
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                className="pl-10 input w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-deep-blue-400 focus:border-deep-blue-400"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href="/forgot-password" className="font-medium text-deep-blue-500 hover:text-deep-blue-400">
