...
const statusMapping = {
  ...
  occupied: { icon: <FiPlay className="text-blue-500" size={14} />, text: 'Occupied', textColor: 'text-blue-600', bgColor: 'bg-blue-100' },
  ...
  undefined: { icon: <FiHelpCircle className="text-gray-500" size={14} />, text: 'Undefined', textColor: 'text-gray-600', bgColor: 'bg-gray-100' },
